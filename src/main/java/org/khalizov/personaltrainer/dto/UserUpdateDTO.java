...
public class UserUpdateDTO {
    @Schema(description = "User ID (for identification)", example = "1")
    ...
    @Schema(description = "Password for the user (leave blank to keep current)", example = "Password123", required = false)
    @Pattern(regexp = "^$|.{3,100}", message = "Password must be empty or between 3 and 100 characters")
